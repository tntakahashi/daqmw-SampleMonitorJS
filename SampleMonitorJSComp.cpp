...
{
    SampleMonitorJSInit(manager);
    RTC::RtcBase* comp;

    // Create a component
    comp = manager->createComponent("SampleMonitorJS");
...
int main (int argc, char** argv)
{
    ...
    // for root application (There's no need to instantiate TApplication when JSROOT is used.)
